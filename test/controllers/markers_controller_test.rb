...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { color: @marker.color, marker_name: @marker.marker_name, type: @marker.type } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { color: @marker.color, marker_name: @marker.marker_name, type: @marker.type } }
